...
namespace imnodes
{
	...
	Style::Style()
		: grid_spacing(48.f), node_corner_rounding(0.f), node_padding_horizontal(8.f),
	...
	void StyleColorsDark()
	{
		...
		g->style.colors[ColorStyle_NodeOutline] = IM_COL32(175, 175, 175, 255);
		// title bar colors match ImGui's titlebg colors
		g->style.colors[ColorStyle_TitleBar] = IM_COL32(0, 122, 104, 255);
		g->style.colors[ColorStyle_TitleBarHovered] = IM_COL32(0, 195, 150, 255);
		g->style.colors[ColorStyle_TitleBarSelected] = IM_COL32(0, 195, 150, 255);
		// link colors match ImGui's slider grab colors
		g->style.colors[ColorStyle_Link] = IM_COL32(224, 173, 0, 200);
		g->style.colors[ColorStyle_LinkHovered] = IM_COL32(234, 193, 0, 255);
		g->style.colors[ColorStyle_LinkSelected] = IM_COL32(254, 213, 0, 255);
		// pin colors match ImGui's button colors
		g->style.colors[ColorStyle_Pin] = IM_COL32(200, 200, 200, 180);
		g->style.colors[ColorStyle_PinHovered] = IM_COL32(200, 200, 200, 255);

		g->style.colors[ColorStyle_BoxSelector] = IM_COL32(173, 173, 173, 30);
		g->style.colors[ColorStyle_BoxSelectorOutline] = IM_COL32(173, 173, 173, 150);

		g->style.colors[ColorStyle_GridBackground] = IM_COL32(40, 40, 40, 200);
	...
	void BeginNode(const int node_id)
	{
		...
		node.layout_style.padding = ImVec2(g->style.node_padding_horizontal, g->style.node_padding_vertical);
